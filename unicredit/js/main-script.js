$(document).ready(function () {
   ...
   /*-- List Active Style --*/
    ...
    $(window).scroll(function() {
        ...
        /* Hide Menu with scroll */
        if (currentScroll > 0) {
            $('.scroll-nav__item > a > span.d').each(function () {
                $(this).removeClass('d').addClass('delete').css('display','none');
            })
        } else {
            $('.scroll-nav__item > a > span.delete').each(function () {
                $(this).removeClass('delete').addClass('d').css('display','');
            });
        }
